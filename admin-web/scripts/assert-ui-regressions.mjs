...
const checks = [
  ...
  ['Trace node badge titles preserve exact raw node ID and status', sharedTraceReplay.includes('title={`${node.id} · ${nodePresentation.raw}`}')],
  ['Current trace node badge has a blue left-side emphasis line', styles.includes('.traceNodeBadge.current') && styles.includes('box-shadow: inset 3px 0 #2563eb')],
