...
const checks = [
  ...
  ['Customer decision badges use compact semantic Carbon-style pills', styles.includes('.decisionBadges') && styles.includes('.decisionBadge.info') && styles.includes('.decisionBadge.success') && styles.includes('.decisionBadge.warning') && styles.includes('.decisionBadge.danger') && styles.includes('.decisionBadge.neutral')],
