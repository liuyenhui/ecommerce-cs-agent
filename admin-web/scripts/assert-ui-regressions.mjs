...
const checks = [
  ...
  ['Decision replay exposes an X6 failure fallback while retaining the timeline', sharedTraceReplay.includes('流程图暂时无法显示，请查看下方节点时间线。') && sharedTraceReplay.includes('setGraphUnavailable(true)') && sharedTraceReplay.includes('aria-label="节点时间线"')],
